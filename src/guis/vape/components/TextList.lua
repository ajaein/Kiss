...
buttonicon.Image = optionsettings.Icon or getcustomasset('newKiss/assets/new/allowedicon.png')
...
icon.Image = optionsettings.Tab or getcustomasset('newKiss/assets/new/allowedtab.png')
icon.Parent = window
