...
icon.Image = getcustomasset('newKiss/assets/new/targetstab.png')
icon.Parent = window
...
optionapi.Players = components.TargetsButton({
	...
	Icon = getcustomasset('newKiss/assets/new/targetplayers1.png'),
	IconSize = UDim2.fromOffset(15, 16),
	IconParent = tool,
	ToolIcon = getcustomasset('newKiss/assets/new/targetplayers2.png'),
...
optionapi.NPCs = components.TargetsButton({
	...
	Icon = getcustomasset('newKiss/assets/new/targetnpc1.png'),
	IconSize = UDim2.fromOffset(12, 16),
	IconParent = tool,
	ToolIcon = getcustomasset('newKiss/assets/new/targetnpc2.png'),
