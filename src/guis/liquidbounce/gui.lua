...
local getcustomassets = {
	['newKiss/assets/liquidbounce/blatant.png'] = 'rbxasset://liquidbounce/blatant.png',
	['newKiss/assets/liquidbounce/combat.png'] = 'rbxasset://liquidbounce/combat.png',
	['newKiss/assets/liquidbounce/expand.png'] = 'rbxasset://liquidbounce/expand.png',
	['newKiss/assets/liquidbounce/inventory.png'] = 'rbxasset://liquidbounce/inventory.png',
	['newKiss/assets/liquidbounce/logo.png'] = 'rbxasset://liquidbounce/logo.png',
	['newKiss/assets/liquidbounce/minigames.png'] = 'rbxasset://liquidbounce/minigames.png',
	['newKiss/assets/liquidbounce/render.png'] = 'rbxasset://liquidbounce/render.png',
	['newKiss/assets/liquidbounce/textgui.png'] = 'rbxasset://liquidbounce/textgui.png',
	['newKiss/assets/liquidbounce/utility.png'] = 'rbxasset://liquidbounce/utility.png',
	['newKiss/assets/liquidbounce/world.png'] = 'rbxasset://liquidbounce/world.png',
...
local function writeFont()
	...
	--[[writefile('newKiss/assets/liquidbounce/lbfont.json', httpService:JSONEncode({
		name = 'Inter',
		faces = {
			{style = 'normal', assetId = getcustomasset('newKiss/assets/liquidbounce/Inter-Light.ttf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('newKiss/assets/liquidbounce/Inter-Regular.ttf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('newKiss/assets/liquidbounce/Inter-Medium.ttf'), name = 'Medium', weight = 500}
		}
	}))]]
	return getcustomasset('newKiss/assets/liquidbounce/lbfont.json')
end
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		expandicon.Image = getcustomasset('newKiss/assets/liquidbounce/expand.png')
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('newKiss/assets/liquidbounce/combat.png'),
	Size = UDim2.fromOffset(16, 15)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('newKiss/assets/liquidbounce/blatant.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('newKiss/assets/liquidbounce/render.png'),
	Size = UDim2.fromOffset(15, 9)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('newKiss/assets/liquidbounce/utility.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('newKiss/assets/liquidbounce/world.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('newKiss/assets/liquidbounce/inventory.png'),
	Size = UDim2.fromOffset(14, 15)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('newKiss/assets/liquidbounce/minigames.png'),
	Size = UDim2.fromOffset(15, 15)
})
